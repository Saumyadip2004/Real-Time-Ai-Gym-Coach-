...
# Suppress MediaPipe and C++ engine logs
...
from services.ui.service_loader import load_css, inject_local_font, inject_webrtc_styles
...
def main():
    ...
    # Initialize LLM Voice Coaching Pipeline
